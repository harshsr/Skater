...
#include "Climber/ClimberCMC.h"

#include "Components/CapsuleComponent.h"
#include "GameFramework/Character.h"

UClimberCMC::UClimberCMC(const FObjectInitializer& ObjectInitializer)
{
	
}


void UClimberCMC::BeginPlay()
{
	Super::BeginPlay();
...
void UClimberCMC::TickComponent(float DeltaTime, ELevelTick TickType,
...
void UClimberCMC::SweepAndStoreWallHits()
{
...
bool UClimberCMC::CanStartClimbing()
{
...
bool UClimberCMC::IsFacingSurface(const float Steepness) const
{
...
bool UClimberCMC::EyeHeightTrace(const float TraceDistance) const
{
...
void UClimberCMC::OnMovementUpdated(float DeltaSeconds, const FVector& OldLocation, const FVector& OldVelocity)
{
	if (bWantsToClimb)
	{
...
void UClimberCMC::OnMovementModeChanged(EMovementMode PreviousMovementMode, uint8 PreviousCustomMode)
{
	if (IsClimbing())
	{
...
void UClimberCMC::SetRotationToStand() const
{
	const FRotator StandRotation = FRotator(0, UpdatedComponent->GetComponentRotation().Yaw, 0);
	UpdatedComponent->SetRelativeRotation(StandRotation);
}

void UClimberCMC::PhysCustom(float deltaTime, int32 Iterations)
{
...
void UClimberCMC::UpdateClimbDashState(float deltaTime)
{
	if (!bIsClimbDashing)
	{
		return;
...
void UClimberCMC::PhysClimbing(float deltaTime, int32 Iterations)
{
...
void UClimberCMC::ComputeSurfaceInfo()
{
...
bool UClimberCMC::ShouldStopClimbing() const
{
...
void UClimberCMC::StopClimbing(float deltaTime, int32 Iterations)
{
	StopClimbDashing();
...
bool UClimberCMC::ClimbDownToFloor() const
{
	FHitResult FloorHit;
...
bool UClimberCMC::CheckFloor(FHitResult& FloorHit) const
{
...
/*
bool UClimberCMC::HasReachedEdge() const
{
...
/*
bool UClimberCMC::CanMoveToLedgeClimbLocation() const
{
	const UCapsuleComponent* Capsule = CharacterOwner->GetCapsuleComponent();
...
/*
bool UClimberCMC::IsLocationWalkable(const FVector& CheckLocation) const
{
...
*/
void UClimberCMC::ComputeClimbingVelocity(float deltaTime)
{
...
void UClimberCMC::AlignClimbDashDirection()
{
...
void UClimberCMC::StopClimbDashing()
{
...
float UClimberCMC::GetMaxSpeed() const
{
	return IsClimbing() ? MaxClimbingSpeed : Super::GetMaxSpeed();
}

float UClimberCMC::GetMaxAcceleration() const
{
	return IsClimbing() ? MaxClimbingAcceleration : Super::GetMaxAcceleration();
}

void UClimberCMC::MoveAlongClimbingSurface(float deltaTime)
{
...
FQuat UClimberCMC::GetClimbingRotation(float deltaTime) const
{
...
/*
bool UClimberCMC::TryClimbUpLedge() const
{
...
void UClimberCMC::SnapToClimbingSurface(float deltaTime) const
{
...
void UClimberCMC::TryClimbDashing()
{
...
void UClimberCMC::StoreClimbDashDirection()
{
...
void UClimberCMC::CancelClimbing()
{
	bWantsToClimb = false;
}

FVector UClimberCMC::GetClimbSurfaceNormal() const
{
	return CurrentClimbingNormal;
}

FVector UClimberCMC::GetClimbDashDirection() const
{
	return ClimbDashDirection;
}

bool UClimberCMC::IsClimbing() const
{
	return MovementMode == EMovementMode::MOVE_Custom && CustomMovementMode == ECustomMovementMode::CMOVE_Climbing;
}

bool UClimberCMC::IsClimbDashing() const
{
